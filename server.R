...
.length_ft <- tryCatch(
  ...
  error = function(e) stop("Failed to compute street segment lengths from geometry: ", e$message, call. = FALSE)
)
if (anyNA(.length_ft)) stop("Computed street segment lengths contain NA values.", call. = FALSE)
